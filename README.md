...
- [WebFinger.js](https://github.com/silverbucket/webfinger.js): JavaScript client library to query WebFinger records
- [secure-store-redis](https://github.com/silverbucket/secure-store-redis): Encrypt the data you store in redis
...
- [Inbox-RS](https://github.com/silverbucket/inbox-rs): An inbox for quickly storing your thoughts, sorting them for reference or todos later.

### CLI
- [dwatch](https://github.com/silverbucket/dwatch): Track disk space growth over time.
